...
const AP_Param::Info var_info[] PROGMEM = {
    ...
    // PI controller
    //--------------
    GGROUP(pid_stabilize_roll,       "STB_RLL_", AC_PID),
    GGROUP(pid_stabilize_pitch,      "STB_PIT_", AC_PID),
    GGROUP(pid_stabilize_yaw,        "STB_YAW_", AC_PID),
